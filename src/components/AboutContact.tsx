...
export default function AboutContact({ reviews }: AboutContactProps) {
  ...
  return (
    <div className="scroll-mt-10">
      ...
      <section
        id="about"
        className="py-16 md:py-24 bg-[#FAF7F2] border-b border-stone-100 text-left"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <p className="text-stone-600 text-sm md:text-base leading-relaxed">
                ...
                , we take pride in being a absolute staple in Cantt View,
                Sargodha. For years, we have brought smiles to families across
                Sargodha with our exceptionally fresh baked items, delicate
                pastries, loaded pizzas, and daily grocery items.
              </p>

              <p className="text-stone-600 text-sm md:text-base leading-relaxed">
                We believe a great business is built on two simple principles:
                **uncompromising quality** and **unmatched hospitality**. That's
                why our baking team starts before sunrise each day to prepare
                fresh buttery croissants and signature chocolate fudge pastries,
                while our mart attendants keep shelves beautifully clean and
                perfectly stocked with local dairy, snacks, and pure honey.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <span className="text-stone-400 text-xs">
                      Helpful, professional greetings.
                    </span>
                  </div>
                </div>
            ...
            <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-6 flex flex-col justify-between">
                ...
                <div className="bg-white p-6 rounded-2xl border border-stone-100 shadow-xs text-left">
                  ...
                  <span className="text-stone-400 text-xs font-semibold block mb-2">
                    Open 7 days a week
                  </span>
                  <span className="text-[#482015] font-extrabold text-sm">
                    Until 12:00 AM Midnight daily
                  </span>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-stone-100 shadow-xs text-left">
                  ...
                  <span className="text-stone-400 text-xs font-semibold block mb-2">
                    Speak directly with Sargodha Cantt branch
                  </span>
                  <a
                    href="tel:+923037041468"
                    className="text-[#482015] hover:text-amber-700 font-extrabold text-sm hover:underline"
                  >
                    +92 303 7041468
                  </a>
                </div>
      ...
      <section
        id="contact"
        className="py-16 md:py-24 bg-white scroll-mt-10 text-left"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              <div>
                ...
                <p className="text-stone-500 text-xs sm:text-sm mt-2 leading-relaxed">
                  Have a custom birthday/wedding cake inquiry or need grocery
                  items delivered? Drop by our store in Sargodha Cantt or leave
                  a message.
                </p>
              </div>
              ...
              <div className="bg-stone-50 border border-stone-100 rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between">
                <div>
                  <h4 className="font-bold text-stone-800 text-sm mb-1">
                    Located in Cantt View
                  </h4>
                  <p className="text-stone-400 text-xs leading-relaxed mb-4">
                    Our shop is conveniently situated right on Mushaf Ali Mir
                    road with beautiful spacious parking and immediate access.
                  </p>
                </div>
            ...
            <div className="lg:col-span-7 bg-stone-50 p-6 md:p-8 rounded-3xl border border-stone-100">
              <h3 className="text-lg font-bold text-[#482015] mb-6">
                  ...
                  <AnimatePresence mode="wait">
                    {isSubmitted ? (
                      ...
                      >
                        ...
                        <span>
                          Thank you! Your inquiry was sent successfully. We will
